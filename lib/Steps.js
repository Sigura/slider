...
var Steps = function Steps(_ref) {
  ...
  var max = _ref.max;
  var min = _ref.min;
  var stepLeft = _ref.stepLeft;

  var range = max - min;
  var elements = calcPoints(vertical, marks, dots, step, min, max).map(function (point, i) {
    var _classNames;

    var offset = !!stepLeft ? stepLeft(point, i) : Math.abs(point - min) / range * 100 + '%';
