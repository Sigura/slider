...
var Slider = function (_React$Component) {
  ...
  Slider.prototype.calcValue = function calcValue(offset) {
    ...
    var value = (ratio - behindPointOffset) / (lastPointOffset - behindPointOffset) * (points[i] - points[step]) + points[step];
  ...
  Slider.prototype.render = function render() {
    ...
    var markLeft = _props5.markLeft;
    var stepLeft = _props5.stepLeft;
...
Slider.propTypes = {
  ...
  markLeft: _react2["default"].PropTypes.func,
  stepLeft: _react2["default"].PropTypes.func,
